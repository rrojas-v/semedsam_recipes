<template>
    <div class="main-wrapper ">
        <div v-if="storeLogin.authenticated"
            class="grid-section flex align-self-center align-items-center justify-content-center">
            <div id="components" class="card forms ">
                <div class="form-wrapper ">
                </div>
            </div>
        </div>
        <div v-if="!storeLogin.authenticated" class="main-container ">
            <div class="grid-section flex align-self-center align-items-center justify-content-center">
                <div id="components" class="card forms ">
                    <div class="form-wrapper ">
                        <FloatLabel class="form-input-wrapper">
                            <InputText id="username" class="form-input" v-model="username" />
                            <label for="username">Username</label>
                        </FloatLabel>
                        <FloatLabel class="form-input-wrapper">
                            <InputText id="password" class="form-input" v-model="password" />
                            <label for="password">Password</label>
                        </FloatLabel>
                        <Button class="form-button p-button-sm" label="Login" @click="btnLoginClic" />
                    </div>
                </div>
        ...
        <div class="footer">
            <div class="footer-content">
                <a href="https://github.com/primefaces/primevue/blob/master/LICENSE.md" target="_blank"
                    class="license">Desarrollado por @ rova sistemas</a>
...
onMounted(() => {
    if (localStorage.getItem('token')) {
        ...
        console.log('localStorage', token.value)
    }
})
const btnLoginClic = () => {
    console.log('btnLoginClic')
    token.value = '********************************'
    //localStorage.setItem('token', token.value)
    storeLogin.authenticated = !!storeLogin.token;
    if (storeLogin.authenticated) {
        router.push('/')
    }
}
watch(token, () => {
